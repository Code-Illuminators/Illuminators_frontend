    ...
    content = (
      <div className="alert alert-primary p-3">
        <h4 className="alert-heading">
          Your current role: {currentUserRole.toUpperCase()}
        </h4>
        <p className="mb-0">There will be something</p>
      </div>
    );
  ...
  return (
    <div className="container py-5">
      <h1 className="mb-4 text-center text-secondary">
        Ongoing Promotion Votes
      </h1>
      <div className="auto-height-override">{content}</div>
    </div>
  );
}
